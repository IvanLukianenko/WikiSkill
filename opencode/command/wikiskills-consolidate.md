...
`.opencode/wikiskills/METHODOLOGY.md` and follow its formats exactly.

1. Get the stratified sample: `python3 .wikiskills/bin/wikiskills.py sample`
...
3. Update `.wikiskills/wiki/patterns/*.md`: both failure and success patterns,
...
6. Mark sampled traces: `python3 .wikiskills/bin/wikiskills.py mark-consolidated <paths>`

...
1. **Wiki Maintenance:** follow `/wikiskill:consolidate` — stratified-sample pending traces, consolidate into patterns/index/log, and harvest new validation tasks (failure-derived first; this is what keeps evolution unblocked). If nothing is pending, note it and continue (the wiki may still hold unexploited knowledge).

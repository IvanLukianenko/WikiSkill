...
1. **Wiki Maintenance:** follow `/wikiskill:consolidate` — stratified-sample pending traces, consolidate into patterns/index/log. If nothing is pending, note it and continue (the wiki may still hold unexploited knowledge).
